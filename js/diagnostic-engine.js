...
(function initDiagnosticEngine(root, factory) {
  ...
  const PATHOGENS = {
    ...
    LEGIONELLA: {
      ...
      isolationFR:'Non contagieux inter-humain — signaler exposition : hôtel, croisière, thermes, spa, tour de refroidissement dans les 10j',
    ...
    MEASLES: {
      ...
      mandatoryReport:true,
      isolationFR:'CONTAGIEUX dès J-4 avant l\'éruption (phase fièvre+toux+yeux rouges) — isolement immédiat dès la suspicion — éviction jusqu\'à J+4 après début éruption — vaccin ROR post-exposition < 72h — déclaration ARS obligatoire',
      criterionFR:'Fièvre + toux + conjonctivite + éruption centrifuge + non-vacciné = ROUGEOLE — ⚠️ contagieux AVANT les boutons (R0 = 15)',
